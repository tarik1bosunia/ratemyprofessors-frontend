...
const HomeHeroSection = () => {
  ...
  const getSearchInputPlaceholder = () => {
    if (view === "school") return "Professor name";
    if (view === "professor") return "Your school";
  };

  const getChangeSearchViewButtonText = () => {
    if (view === "school")
      return <>I want to find a professor at a school</>;
    if (view === "professor")
      return <>I&apos;d like to look up a professor by name</>;
  };
